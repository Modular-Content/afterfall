		...
		if text then
			...
			for k, v in pairs(text) do
				...
				elseif type(v) == "Player" then
					Clockwork.chatBox:WrappedText(nil, message, v:GetTeamClass().color, v:Name(), curOnHover)
					curColor = nil
					curOnHover = nil
				elseif type(v) == "table" then
...
Clockwork.chatBox:RegisterDefaultClass("priv", "ooc", function(info)
	local classColor = info.speaker:GetTeamClass().color
...
Clockwork.chatBox:RegisterDefaultClass("chat", "ooc", function(info)
	...
	if speaker then
		local classColor = speaker:GetTeamClass().color
