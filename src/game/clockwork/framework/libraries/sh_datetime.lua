...
function Clockwork.time:GetMinute()
	if CLIENT then
		return Clockwork.kernel:GetNetVar("Minute")
	else
		return self.minute
	end
end
...
function Clockwork.time:GetHour()
	if CLIENT then
		return Clockwork.kernel:GetNetVar("Hour")
	else
		return self.hour
	end
end
...
function Clockwork.time:GetDay()
	if CLIENT then
		return Clockwork.kernel:GetNetVar("Day")
	else
		return self.day
	end
end
...
if SERVER then
	...
	function Clockwork.date:GetString()
		return Clockwork.kernel:GetNetVar("Date")
	end
