...
Clockwork.config:Add("show_business", true, true, nil, nil, nil, nil, true)
...
Clockwork.config:Add("description_crafting", "Combine various items to make new items.", true, nil, nil, nil, nil, true)
Clockwork.config:Add("crafting_menu_enabled", false, true, nil, nil, nil, nil, true)
Clockwork.config:Add("enable_voice_commands", true, true)
Clockwork.config:Add('smooth_sprint_enabled', true, true)